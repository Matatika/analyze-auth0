...
datasets:
	source venv/bin/activate && convert bundle/analyze/datasets/tap-auth0/ rawdata/ bundle/analyze/datasets/tap-auth0/output || convert bundle/analyze/datasets/tap-auth0/ rawdata/ bundle/analyze/datasets/tap-auth0/output
